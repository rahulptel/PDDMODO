...
struct BDDMultiObj {
    ...
    // Find pareto frontier from dynamic layer cutset / CUDA
    static ParetoFrontier* pareto_frontier_dynamic_layer_cutset_cuda(BDD* bdd, bool maximization=true, const int problem_type=-1, const int dominance_strategy=0, MultiObjectiveStats* stats = NULL);
